...
export const Terms = () => {
	return (
		<Container>
			...
			<p>
				Nothing on this website constitutes an offer or recommendation to buy, sell, or invest. It is your sole responsibility to determine the appropriateness of any purchase or related transaction based on your personal goals, financial situation, and risk tolerance. For legal, tax, insurance, or business advice, you should consult with trusted, licensed professionals and advisors.			</p>
			<p>
				We may periodically update this policy and will notify you of these changes by posting the revised terms on our platforms. We recommend revisiting this policy regularly.
			</p>
